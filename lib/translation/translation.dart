...
class Translation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        ...
        'ar_AR': {
          ...
          'deletedTodoQuery': 'هل أنت متأكد من أنك تريد حذف المهمة ؟',
          'delete': 'احذف',
          'cancel': 'الغِ',
          'editing': 'تعديل',
          'name': 'إسم',
          ...
          'deleteCategoryQuery': 'هل أنت متأكد من أنك تريد خذف الفئة ؟',
          'todo': 'المهام',
          'allTodos': 'كل المهام',
          'create': 'أنشِئ',
          'completed': 'منتهي',
          ...
          'archiveCategoryQuery': 'هل أنت متأكد من أنك تريد أرشفة الفئات ؟',
          'archive': 'إلى الأرشيف',
          'categoryArchive': 'الفئة في الأرشيف',
          'noArchiveCategory': 'استعد الفئة',
          'noArchiveCategoryQuery': 'هل أنت متأكد من أنك تريد إسترجاع الفئة ؟',
          'noArchive': 'عد',
          ...
          'settings': 'الإعدادات',
          'backup': 'عمل نسخ إحتياطية لبينات المستخدم',
          'restore': 'إستعد بينات المستخدم',
          'deleteAllBD': 'إخذف جميع البينات',
          'deleteAllBDTitle': 'خذف البينات',
          'deleteAllBDQuery': 'هل أنت متأكد أنك تريد حذف جميع البينات',
          'errorPath': 'لم تختر مسار لحفض النسخ الإحتياطية',
          'error': 'حدث خطأ ما',
          'successBackup': 'تم إنشاء النسخة الاحتياطية بنجاح',
          'errorPathRe':
              'لم تختر أي ملفات نسخ إحتياطية لإستعادة البيانات الخاصة بك',
          ...
          'calendar': 'تقويم',
          'theme': 'سمة',
          'materialColor': 'ألوان الديناميكية',
          'amoledTheme': 'سمة سوداء (AMOLED)',
          'appearance': 'المضهر',
          'functions': 'دوال',
          'data': 'بينات',
          'language': 'اللغة',
